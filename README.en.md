...
[![Views local](https://img.shields.io/badge/Views_local-76-ff6900?style=for-the-badge&logo=github)](https://github.com/gooog1111/SupportChat)
...
- **Safety**  
  ...
  - 🔑 Session and authorization system- 📁 Storing data in JSON files  
...
1. Install packages:  
   ...
   ```
2. Place the project in `/var/www/html/chat`.3. Set up a virtual host:  
   ```apache  
   <VirtualHost *:80>  
...
```bash0 3 * * * find /path/to/clients/ -type f -mtime +1 -delete
```
...
│ ├── css/ # Styles
│ │ ├── admin.css # Styles for the admin panel│ │ ├── all.min.css # Minified styles (for example, FontAwesome)
│ │ ├── index.php # Protection against direct access
...
│ └── index.php # Protection against direct access
├── client/ # Client part
│ ├── get_messages.php # Receiving messages for the client
...
├── clients/ # Client data (JSON files)│ └── index.php # Protection against direct access
